...
script_name("paha1n")
script_url("https://github.com/paha1n/moonloader-script-updater")
script_version("1.0")
...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/paha1n/whitelist/master/paha1n.json?" .. tostring(os.clock())
            Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
            Update.url = "https://github.com/paha1n/moonloader-script-updater/"
        end
    end
end
